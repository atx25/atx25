...
void parseUserData(String content){
  ...
  const char* results_0_daily_textNight = result_0_daily["textNight"];
  ...
  Serial.println("白天天气"+results_0_daily_textDay);
  Serial.println("夜间天气"+results_0_daily_textNight);
  Serial.println("预报日期"+results_0_daily_fxData);
  Serial.print("\r\n");
}
void setup() {
